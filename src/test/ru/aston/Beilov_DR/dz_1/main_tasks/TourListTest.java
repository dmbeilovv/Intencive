...
class TourListTest {
    ...
    @Test
    void testAddTourAddsTourToList() {
    ...
    @Test
    void testDeleteTourRemovesTourFromList() {
        User user = new User(30, "John", "Doe");
        Tour tour = new BusTour(user, 100.0, "Paris");
    ...
    @Test
    void testDeleteNonExistentTourReturnsFalse() {
        User user = new User(30, "John", "Doe");
        Tour tour = new BusTour(user, 100.0, "Paris");
        TourList tourList = new TourList();
    ...
    @Test
    void testGetFinalPriceCalculatesTotalPriceCorrectly() {
    ...
    @Test
    void testSortListByUsersNameSortsToursByUserName() {
        User user1 = new User(30, "John", "Doe");
    ...
    @Test
    void testGetToursListReturnsCopyOfList() {
        User user = new User(30, "John", "Doe");
        Tour tour = new BusTour(user, 100.0, "Paris");
        TourList tourList = new TourList(new ArrayList<>(List.of(tour)));
